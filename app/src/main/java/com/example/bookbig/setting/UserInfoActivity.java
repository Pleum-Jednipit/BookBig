...
public class UserInfoActivity extends AppCompatActivity {
    ...
    private Button mSetting,mProfile,mNewBookcover,mSwipe,mLogout;
...
//                finish();
        ...
        mNewBookcover.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        mLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(UserInfoActivity.this, PhoneLoginActivity.class);
                startActivity(intent);
                finish();
            }
        });
